...
// core components
import { routes, advertiser_routes } from '../routes.js';
  ...
  render() {
    ...
    return (
      <div className='wrapper'>
        ...
        <Sidebar
          {...this.props}
          routes={this.props.role === 'advertiser' && advertiser_routes}
          activeTab={activeTab}
        ...
        >
          ...
          />
          {this.getRoutes(this.props.role === 'advertiser' && advertiser_routes)}
        </div>
        <Footer />
      </div>
    );
